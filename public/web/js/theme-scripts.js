...
(function(a) {
    a.fn.countTo = function(g) {
        ...
        return a(this).each(function() {
            ...
            var b = a.extend({}, a.fn.countTo.defaults, { from: a(this).data("from"), to: a(this).data("to"), speed: a(this).data("speed"), refreshInterval: a(this).data("refresh-interval"), decimals: a(this).data("decimals") }, g),
...
function changeTraveloElementUI() {
    ...
    tjq('.datepicker-wrap input').each(function() {
        ...
        //tjq(this).closest('form').find('input[name="date_to"]').datepicker("setDate", new Date());
...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq(tjq("#meneu_scroll").html()).insertBefore('.chaser .menu');
